    ...
    m_Header("headertree", "Header chain")
{
    ...
    // save cluster file name wihtout the number and _CLZ.root
...
void TreeHandler::ReadTree(TTreeReader* reader){
    ...
    // TTreeReaderValue is used to store data of a Branch, which is the
    // name of the second parameter 
    TTreeReaderValue< std::vector<int> > row_seed(*reader, "row_seed");     // Seed y coordinate
    TTreeReaderValue< std::vector<int> > col_seed(*reader, "col_seed");     // Seed x ooordinate
    ...
    // save the values stored in all the branches
